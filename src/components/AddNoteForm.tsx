...
import { addNote } from '@/lib/dbActions'; // Make sure to import the correct function for adding a contact
...
const onSubmit = async (data: {
  ...
  contactId: number; // The ID of the contact this note belongs to
  owner: string; // The owner of the note, typically the user's email
}) => {
