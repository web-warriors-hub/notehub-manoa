              ...
              <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Row>
                  <Col>
                    <Form.Group>
                      ...
                      <input
                        type="text"
                        defaultValue={contact.firstName} // Pre-fill with existing value
                        {...register('firstName')}
                  ...
                  <Col>
                    <Form.Group>
                      ...
                      <input
                        type="text"
                        defaultValue={contact.lastName} // Pre-fill with existing value
                        {...register('lastName')}
                ...
                <Row>
                  <Col>
                    <Form.Group>
                      ...
                      <input
                        type="text"
                        defaultValue={contact.address} // Pre-fill with existing value
                        {...register('address')}
                  ...
                  <Col>
                    <Form.Group>
                      ...
                      <input
                        type="text"
                        defaultValue={contact.image} // Pre-fill with existing value
                        {...register('image')}
                ...
                <Form.Group>
                  ...
                  <textarea
                    ...
                    defaultValue={contact.description} // Pre-fill with existing value
